 ...
 * @subpackage KOC_Physicians_Network_Sync/public
 */
 ...
 */
class KOC_Physicians_Network_Sync_Public {
	 ...
	 *
	 * @since    1.0.0
	 * @param      string    $koc_physicians_network_sync       The name of the plugin.
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->koc_physicians_network_sync, plugin_dir_url( __FILE__ ) . 'css/koc-physicians-network-sync-public.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->koc_physicians_network_sync, plugin_dir_url( __FILE__ ) . 'js/koc-physicians-network-sync-public.js', array( 'jquery' ), $this->version, false );
